/// \file cylinder.cpp
/// \brief Implementation file for V-ART class "Cesto".
...
VART::Cesto::Cesto() : VART::Cylinder()
{
}

void VART::Cesto::SetDimensions(float r, float h)
{
    radius = r;
    height = h;
    SetRadius(r);
...
bool VART::Cesto::DrawInstanceOGL() const
{
#ifdef VART_OGL
